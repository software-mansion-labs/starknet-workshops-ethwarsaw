...
func assert_auction_does_not_exist{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    auction_id
) {
    alloc_locals;
...
func assert_auction_not_finalized{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    auction_id
) {
